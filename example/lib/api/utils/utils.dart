...
import 'package:onchain_swap_example/api/services/providers/ethereum_ws.dart';
import 'package:onchain_swap_example/api/services/providers/solana.dart';
import 'package:onchain_swap_example/api/services/providers/substrate.dart';
import 'package:onchain_swap_example/api/services/providers/substrate_ws.dart';
import 'package:onchain_swap_example/api/services/providers/tendermint.dart';
  ...
  static Future<AppClient> buildClient(
    ...
    switch (network.type) {
      case SwapChainType.solana:
        final client = await SwapSolanaClient.check(
      ...
      case SwapChainType.cosmos:
        ...
        return AppClient(
          client: await SwapCosmosClient.check(
              provider:
      ...
      case SwapChainType.polkadot:
        switch (provider.protocol) {
          case ServiceProtocol.http:
            return AppClient(
                client: await SwapSubstrateClient.check(
      ...
      case SwapChainType.bitcoin:
        ...
        return AppClient(
            client: await SwapBitcoinClient.check(
      ...
      case SwapChainType.ethereum:
        switch (provider.protocol) {
          case ServiceProtocol.http:
            return AppClient(
                client: await SwapEthereumClient.check(
