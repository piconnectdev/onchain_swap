...
class SwapRouteEthereumTransactionBuilder extends SwapRouteTransactionBuilder<
  ...
  Future<void> buildTransactions({
    required GETNETWORK<EthereumClient, SwapEthereumNetwork> client,
    ...
    for (final operation in operations) {
      ...
      final ethereumClient = await client(operation.network);
...
abstract class SwapRouteEthereumTransactionOperation
  ...
  Future<Web3TransactionEthereum?> _buildTransactions(EthereumClient client);
}
...
class SwapRouteEthereumSendTokenTransactionOperation
  ...
  Future<Web3TransactionEthereum> _buildTransactions(
    ...
    final tokenBalance =
        await client.getERC20TokenBalance(address: source, contract: contract);
