...
class SwapRouteSolanaTransactionBuilder extends SwapRouteTransactionBuilder<
  ...
  Future<void> buildTransactions({
    required GETNETWORK<SolanaClient, SwapSolanaNetwork> client,
    ...
    for (final operation in operations) {
      ...
      final solanaClient = await client(operation.network);
...
abstract class SwapRouteSolanaTransactionOperation
  ...
  Future<Web3TransactionSolana> _buildTransactions(SolanaClient client);
  // final String? memo;
...
class SwapRouteSolanaNativeTransactionOperation
  ...
  Future<Web3TransactionSolana> _buildTransactions(SolanaClient client) async {
