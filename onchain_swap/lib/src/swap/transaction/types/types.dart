...
typedef GETNETWORK<CLIENT extends NetworkClient, NETWORK extends SwapNetwork>
...
class Web3TransactionBitcoinOutputs {
  ...
  const Web3TransactionBitcoinOutputs(
      {this.address, this.script, required this.value});
}
  ...
  factory BitcoinSpenderAddress(
    ...
    if (type.isP2sh) {
      ...
      if (witnessScript != null) {
        ...
        if (p2shAddress.toScriptPubKey() != p2shreedemScript) {
