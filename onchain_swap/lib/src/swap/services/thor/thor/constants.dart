...
class ThorSwapConstants {
  ...
  static final SwapNativeAsset avaxAvax = SwapNativeAsset(
      symbol: "AVAX",
  ...
  static final SwapNativeAsset baseEth = SwapNativeAsset(
      symbol: "ETH",
  ...
  static final ETHSwapAsset baseUsdc = ETHSwapAsset(
      ...
      fullName: "USDC");
  static final SwapNativeAsset bchBch = SwapNativeAsset(
      symbol: "BCH",
  ...
  static final SwapNativeAsset bscBnb = SwapNativeAsset(
      symbol: "BNB",
  ...
  static final ETHSwapAsset bscUsdt = ETHSwapAsset(
      ...
      fullName: "Tether");
  static final SwapNativeAsset btcBtc = SwapNativeAsset(
      symbol: "BTC",
      ...
      coingeckoId: "bitcoin",
      fullName: "Bitcoin");
  static final SwapNativeAsset dogeDoge = SwapNativeAsset(
      symbol: "DOGE",
  ...
  static final SwapNativeAsset ethEth = SwapNativeAsset(
      symbol: "ETH",
  ...
  static final SwapCosmosAsset gaiaAtom = SwapCosmosAsset(
      symbol: "ATOM",
      ...
      coingeckoId: "cosmos",
      fullName: "Cosmos Hub");
  static final SwapNativeAsset ltcLtc = SwapNativeAsset(
      symbol: "LTC",
