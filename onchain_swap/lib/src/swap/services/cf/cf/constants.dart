...
class CfSwapConstants {
  ...
  static const SwapNativeAsset eth = SwapNativeAsset(
      symbol: "ETH",
  ...
  static final ETHSwapAsset ethUsdc = ETHSwapAsset(
      ...
      fullName: "USDC");
  static const SwapNativeAsset dot = SwapNativeAsset(
      symbol: "Dot",
      ...
      fullName: "Polkadot");
  static const SwapNativeAsset bticoin = SwapNativeAsset(
      symbol: "BTC",
  ...
  static const SwapNativeAsset arbEth = SwapNativeAsset(
      symbol: "ETH",
      providerIdentifier: "ETH",
      decimal: 18,
  ...
  static final ETHSwapAsset arbUsdc = ETHSwapAsset(
      ...
      fullName: "USDC");
  static const SwapNativeAsset sol = SwapNativeAsset(
      symbol: "SOL",
