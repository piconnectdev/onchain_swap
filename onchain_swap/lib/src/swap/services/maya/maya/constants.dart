...
class MayaSwapConstants {
  ...
  static final SwapNativeAsset arbEth = SwapNativeAsset(
      symbol: "ETH",
  ...
  static final SwapNativeAsset btcBtc = SwapNativeAsset(
      ...
      coingeckoId: "bitcoin",
      fullName: "Bitcoin");
  static final SwapNativeAsset dashDash = SwapNativeAsset(
      symbol: "DASH",
  ...
  static final SwapCosmosAsset kujiKuji = SwapCosmosAsset(
      symbol: "KUJI",
      ...
      coingeckoId: "kujira",
      fullName: "Kujira");
  static final SwapCosmosAsset kujiUsk = SwapCosmosAsset(
      symbol: "USK",
      ...
      coingeckoId: "usk",
      fullName: "USK");
  static final SwapCosmosAsset thorRune = SwapCosmosAsset(
      symbol: "RUNE",
