...
class SwapCosmosAsset extends BaseSwapAsset {
  final String denom;
  const SwapCosmosAsset(
      {required super.symbol,
      required super.providerIdentifier,
      required super.decimal,
      required super.network,
...
class SwapRouteGeneralTransactionBuilderParam {
  final String sourceAddress;
  final String destinationAddress;
  // final List<BitcoinSpenderAddress>? bitcoinAddresses;
  // final CosmosSpenderAddress? cosmosSourceAddress;
